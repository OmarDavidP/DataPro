                    ...
                    <div class="modal-content">
                              ...
                              <form action="" method="post">
								...
								<div class="input-group-prepend">
									...
									?>
									<label for="id_senacbc" class="form-label"></label>
									<select class="form-control" name="id_senacbc" id="id_senacbc" required>
									<?php
									...
									<div class="input-group col-sm-12 col-md-10 col-form-label">
										...
										<input type="number" class="form-control" placeholder="Identificacion del instructor" name="documento"  id="documento"required > 
									</div>
									<div class="input-group col-sm-12 col-md-10 col-form-label">
										<div class="input-group-prepend">
											<span class="input-group-text ">
										...
										<input type="text" class="form-control" placeholder="Nombres del instructor" name="nombre" id="nombre" required >
									</div>
									...
									<div class="input-group col-sm-12 col-md-10 col-form-label">
										...
										<input type="number" class="form-control" placeholder="Telefono del instructor" id="telefono" name="telefono" required >
									</div>
									<div class="input-group col-sm-12 col-md-10 col-form-label">
										<div class="input-group-prepend">
											<span class="input-group-text ">
										...
										<input type="email" class="form-control" placeholder="Correo del instructor" id="correo" name="correo" required >
									</div>
									<div class="input-group col-sm-12 col-md-10 col-form-label">
										<div class="input-group-prepend">
											<span class="input-group-text ">
										...
										<input type="text" class="form-control" placeholder="Direccion del instructor" id="direccion" name="direccion" required>
									</div>
									<br>

	...
	<script src="../Estilos/js/plugin/sweetalert/sweetalert2.min.js"></script>
	<script src="../Estilos/js/alerta.js"></script>
	<script >
...
<script>	
		...
		var SweetAlert2Demo = function() {
			...
			var initDemos = function() {
				...
				$('#alert_demo_3_3').click(function(e) {
					swal("Buen trabajo!", "Registro exitoso!", {
						icon : "success",
						timer:"7000",
						buttons: {        			
							confirm: {
				...
				$('#alert_demo_7').click(function(e) {
					swal({
						title: 'Estas seguro?',
						text: "Quieres asignar este ambiente a <?php echo $lista['nombre'] ?>!",
						type: 'warning',
						timer:"9000",
						buttons:{
							confirm: {
		...
		$('.btn-del').on('click', function(e) {
			...
			if (result.value) {
				document.location.href =('../../Modelo/Datos_pasante/delete.php');
			} else {
				swal("Your imaginary file is safe!", {
					buttons : {
						confirm : {

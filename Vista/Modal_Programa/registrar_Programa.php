          ...
          <div class="modal-dialog" role="document">
                    <div class="modal-content">
                              <div class="modal-header no-bd" style="background: #667db6;  /* fallback for old browsers */
                                        ...
                                        ">
                                        <h1 class="modal-title" style="color:white;">
                              ...
                              <form action="" method="post">
                                        ...
                                        <div class="input-group col-sm-12 col-md-10 col-form-label">
                                                  ...
                                                  <label for="nombre_progra" class="form-label"></label>
                                                  <input type="text" class="form-control" placeholder="Nombre del programa" id="nombre_progra" name="nombre_progra" required > 
                                        </div>

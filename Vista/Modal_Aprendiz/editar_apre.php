...
<div class="modal fade" id="exampleModal<?php echo $lista['id_aprendiz'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content" data-background-color="purple">
            ...
            <form action="../../Modelo/Datos_pasante/update.php" id="edit-form">
				<input type="hidden" class="form-control" value="<?php echo $lista['id_aprendiz'] ?>"  name="id_aprendiz" required > 
							...
							<div class="modal-footer">
								...
								<button type="submit" class="btn btn-primary" id="btnUpdateSubmit">Guardar Cambios</button>
							</div>
						</form>
			</div>
...
<h2 style="background: #00B4DB;  /* fallback for old browsers */
		background: -webkit-linear-gradient(to right, #0083B0, #00B4DB);  /* Chrome 10-25, Safari 5.1-6 */
		background: linear-gradient(to right, #0083B0, #00B4DB); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */"></h2>